...
const packages = [
  {
    ...
    price: '24,999',
    rating: 4.9,
    inclusions: ['Luxury Houseboat', 'Shikara Ride', 'Private Car', 'All Meals', 'Guided Tours'],
    image: '/dest-kashmir.png',
  },
  {
    name: 'Leh Ladakh Odyssey',
    destination: 'Leh Ladakh',
    duration: '6 Nights / 7 Days',
    price: '29,999',
    rating: 5.0,
    inclusions: ['Premium Stay', 'Pangong Lake', 'Nubra Valley', 'Bike Rental', 'Oxygen Kit'],
    image: 'https://images.unsplash.com/photo-1589308078059-be1415eab4c3?q=80&w=2000&auto=format&fit=crop',
  },
  {
    name: 'Himachal Highlands',
    destination: 'Himachal Pradesh',
    duration: '5 Nights / 6 Days',
    price: '19,999',
    rating: 4.8,
    inclusions: ['Mountain Cottage', 'Paragliding', 'Rohtang Pass', 'Campfire', 'Sightseeing'],
  ...
  },
  {
    ...
    price: '22,999',
    rating: 4.8,
    inclusions: ['Premium Houseboat', 'Spa Sessions', 'Authentic Meals', 'Beach Resort', 'Backwater Cruise'],
  ...
  },
  {
    ...
    price: '17,999',
    rating: 4.7,
    inclusions: ['Rishikesh Stay', 'River Rafting', 'Char Dham Darshan', 'Yoga Sessions', 'All Meals'],
  ...
  },
  {
    ...
    price: '26,999',
    rating: 4.9,
    inclusions: ['Heritage Hotel', 'Desert Safari', 'Camel Ride', 'Folk Performances', 'Guided Forts Tour'],
